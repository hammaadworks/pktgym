...
import { Smartphone, Zap, Activity, Gamepad2, HeartPulse, Trophy } from 'lucide-react';
      ...
      <main className="relative z-10 flex flex-col items-center max-w-7xl mx-auto px-6 pt-24 pb-32">
        ...
        <section className="flex flex-col items-center text-center space-y-10 mt-16 md:mt-24 w-full">
          ...
          >
            ...
            <span className="text-xs font-black uppercase tracking-[0.3em] text-white/70">No VR headset. Just your phone.</span>
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-7xl md:text-[8rem] lg:text-[10rem] font-black tracking-tighter leading-[0.8] uppercase"
          >
            POCKET YOUR <br />
          ...
          <motion.div 
            ...
            className="pt-8"
          >
            <Link href="/play" className="group relative inline-flex items-center gap-6 px-12 py-6 bg-orange-500 hover:bg-orange-400 text-white rounded-[3rem] font-black uppercase tracking-[0.4em] text-lg transition-all duration-500 shadow-[0_0_80px_rgba(249,115,22,0.4)] hover:shadow-[0_0_120px_rgba(249,115,22,0.6)] hover:-translate-y-2">
        ...
        <section className="mt-40 w-full flex flex-col items-center text-center">
           <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-20">The <span className="text-orange-500">Setup</span></h2>
           
           <div className="flex flex-col md:flex-row items-center gap-12 w-full max-w-5xl justify-between">
              <div className="flex-1 flex flex-col items-center gap-6">
                 <div className="w-24 h-24 rounded-[2.5rem] bg-white/5 border border-white/10 flex items-center justify-center text-4xl font-black text-white/30">1</div>
                 <p className="text-xl font-black uppercase tracking-widest">Open on big screen</p>
              ...
              <div className="flex-1 flex flex-col items-center gap-6">
                 <div className="w-24 h-24 rounded-[2.5rem] bg-white/5 border border-white/10 flex items-center justify-center text-4xl font-black text-white/30">2</div>
                 <p className="text-xl font-black uppercase tracking-widest">Scan the QR code</p>
                 <p className="text-xs text-white/40 uppercase tracking-widest font-bold">With your smartphone</p>
              </div>
              <div className="w-8 h-1 bg-gradient-to-r from-transparent via-white/20 to-transparent hidden md:block" />
              <div className="flex-1 flex flex-col items-center gap-6">
                 <div className="w-24 h-24 rounded-[2.5rem] bg-orange-500/10 border border-orange-500/20 flex items-center justify-center text-4xl font-black text-orange-500 shadow-[0_0_30px_rgba(249,115,22,0.3)]">3</div>
                 <p className="text-xl font-black uppercase tracking-widest text-orange-500">Pocket & Play</p>
        ...
        <section className="mt-40 w-full">
          <div className="relative bg-gradient-to-br from-orange-600/20 to-purple-600/20 border border-white/10 rounded-[4rem] p-16 md:p-24 text-center overflow-hidden flex flex-col items-center">
            ...
            <h2 className="relative z-10 text-5xl md:text-7xl font-black uppercase tracking-tighter mb-8 leading-none">Ready to drop <br/>the <span className="text-orange-500">excuses?</span></h2>
            <Link href="/play" className="relative z-10 px-10 py-5 bg-white text-black hover:bg-neutral-200 rounded-[2rem] font-black uppercase tracking-[0.3em] transition-transform hover:scale-105">
              Launch Browser Gym
            </Link>
          </div>
        </section>
