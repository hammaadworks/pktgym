...
export default function MobileController() {
 ...
 <h2 className="text-2xl font-bold text-white uppercase ">Invalid Link</h2>
 ...
 <h1 className="text-4xl font-bold tracking-tight text-white/90">Motion Core</h1>
 ...
 className="bg-red-500/10 border border-red-500/20 text-red-200 p-6 rounded-3xl w-full shadow-lg flex flex-col gap-4 mb-4"
 >
 <div className="flex items-center gap-3">
 <WifiOff className="w-6 h-6 text-red-500" />
 <p className="text-xs font-bold uppercase tracking-widest text-red-500">Diagnostic Failure</p>
 </div>
 <p className="text-sm font-medium leading-relaxed opacity-90 ">{error}</p>
 <button 
 onClick={() => setError('')}
 className="mt-2 w-full py-3 bg-red-500/20 rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-red-500/30 transition-colors"
 >
 ...
 className={cn(
 "w-full aspect-square max-w-[200px] md:max-w-[240px] rounded-[3rem] text-2xl font-bold shadow-2xl flex flex-col items-center justify-center gap-4 transition-all duration-500 group relative overflow-hidden border-4",
 ...
 "w-16 h-16 md:w-20 md:h-16 relative z-10 transition-transform duration-500 group-hover:scale-110",
 connectionStatus === 'connected' ? "opacity-100" : "opacity-20"
 )} />
 <span className="relative z-10 tracking-widest uppercase text-sm">Initialize</span>
 </motion.button>
 <p className="text-xs text-white/40 text-center max-w-[240px] leading-relaxed">
 Make sure you hold the device securely. Grant motion permissions if prompted.
 </p>
 </div>
 ) : (
 ...
 <p className="text-xs text-white/30 font-bold uppercase tracking-[0.4em] text-center ">Remote Navigation</p>
 ...
 <p className="text-xs text-orange-500 font-bold uppercase tracking-[0.3em] mb-1 ">Placement</p>
 ...
 className="flex-1 flex flex-col items-center justify-center gap-2 p-4 bg-white/5 hover:bg-white/10 active:bg-orange-500/20 border border-white/10 rounded-[2rem] text-white/50 hover:text-white transition-all font-bold uppercase tracking-widest text-[10px] "
 >
 ...
 className="flex-1 flex flex-col items-center justify-center gap-2 p-4 bg-red-500/10 hover:bg-red-500/20 active:bg-red-500/40 border border-red-500/20 rounded-[2rem] text-red-400 transition-all font-bold uppercase tracking-widest text-[10px] "
 >
